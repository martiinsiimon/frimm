...
__filter_name__ = 'Red filter'
__filter_description__ = 'Simple red color filter with no options. Only red channel remains.'
...
def process(in_img, out_img):
    ...
    for y in xrange(height):
        for x in xrange(width):
            ...
            out_img[pix_index + r_out_off] = in_img[pix_index + r_in_off]
